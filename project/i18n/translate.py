...
CATALOG: dict[str, dict[str, str]] = {
    ...
    "auth.consent_notice":  {"en": "MedBridge processes health-related information you share (symptoms, bookings, prescriptions, reports) only to navigate care — never to diagnose. You can request deletion later under applicable privacy law (PDPA).",
                             "si": "MedBridge ඔබ බෙදාගන්නා සොක්‍ය තොරතුරු රැකවරණ මාර්ගෝපදේශනය සඳහා පමණක් සකසයි — රෝග විනිශ්චය සඳහා නොවේ. PDPA යටතේ පසුව මකාදැමීමට ඉල්ලිය හැක.",
                             "ta": "MedBridge நீங்கள் பகிரும் சுகாதாரத் தகவலை பராமரிப்பு வழிகாட்டலுக்கு மட்டும் செயலாக்கும் — நோய் கண்டறிதலுக்கு அல்ல. PDPA கீழ் பின்னர் நீக்கக் கோரலாம்."},
    "auth.consent_checkbox":{"en": "I understand this is not a diagnosis service and I consent to processing my health-related data for care navigation.",
                             "si": "මෙය රෝග විනිශ්චය සේවාවක් නොවන බව මම තේරුම් ගනිමි; රැකවරණ මාර්ගෝපදේශනය සඳහා මගේ සොක්‍ය දත්ත සැකසීමට එකඟ වෙමි.",
                             "ta": "இது நோய் கண்டறிதல் சேவை அல்ல என்பதை புரிந்துகொள்கிறேன்; பராமரிப்பு வழிகாட்டலுக்கு என் சுகாதாரத் தரவைச் செயலாக்க ஒப்புக்கொள்கிறேன்."},
    "auth.consent_required":{"en": "Please tick the consent checkbox to create an account.",
                             "si": "ගිණුමක් සෑදීමට කරුණාකර කැමැත්ත කොටුව ලකුණු කරන්න.",
                             "ta": "கணக்கை உருவாக்க ஒப்புதல் பெட்டியைத் தேர்ந்தெடுக்கவும்."},
    ...
    "em.sms_sent":          {"en": "SMS alert sent to your family contact number.",
                             "si": "SMS alert sent to your family contact number.",
                             "ta": "SMS alert sent to your family contact number."},
    "em.sms_failed":        {"en": "SMS alert could not be sent (check SMS gateway config).",
                             "si": "SMS alert could not be sent (check SMS gateway config).",
                             "ta": "SMS alert could not be sent (check SMS gateway config)."},
    ...
    "panel.booking.pick_row":{"en": "Pick a time below and click Book to confirm.",
                             "si": "පහත වේලාවක් තෝරා Book ඔබන්න.",
                             "ta": "கீழே ஒரு நேரத்தைத் தேர்ந்தெடுத்து Book அழுத்தவும்."},
    ...
    "panel.appointments.title":{"en": "My appointments",
                             "si": "මගේ හමුවීම්",
                             "ta": "என் சந்திப்புகள்"},
    "panel.appointments.hint":{"en": "Cancel a future confirmed appointment to free the slot for others.",
                             "si": "Cancel a future confirmed appointment to free the slot for others.",
                             "ta": "Cancel a future confirmed appointment to free the slot for others."},
    "panel.appointments.row":{"en": "**#{id}** · {doctor} at {facility} · {date} {time}",
                             "si": "**#{id}** · {doctor} — {facility} · {date} {time}",
                             "ta": "**#{id}** · {doctor} — {facility} · {date} {time}"},
    "panel.appointments.cancel":{"en": "Cancel",
                             "si": "අවලංගු කරන්න",
                             "ta": "ரத்து செய்"},
    "panel.appointments.cancel_fail":{"en": "Could not cancel — only your future confirmed appointments can be cancelled.",
                             "si": "Could not cancel — only your future confirmed appointments can be cancelled.",
                             "ta": "Could not cancel — only your future confirmed appointments can be cancelled."},
    "panel.appointments.cancelled":{"en": "Cancelled {doctor} on {date} at {time}. Slot is available again.",
                             "si": "Cancelled {doctor} on {date} at {time}. Slot is available again.",
                             "ta": "Cancelled {doctor} on {date} at {time}. Slot is available again."},
    "panel.appointments.reschedule":{"en": "Reschedule", "si": "Reschedule", "ta": "Reschedule"},
    "panel.appointments.reschedule_pick":{"en": "Pick a new slot with the same doctor:",
                             "si": "Pick a new slot with the same doctor:",
                             "ta": "Pick a new slot with the same doctor:"},
    "panel.appointments.reschedule_none":{"en": "No alternative slots found for this doctor in the next week.",
                             "si": "No alternative slots found for this doctor in the next week.",
                             "ta": "No alternative slots found for this doctor in the next week."},
    "panel.appointments.reschedule_fail":{"en": "Could not reschedule — slot may have been taken.",
                             "si": "Could not reschedule — slot may have been taken.",
                             "ta": "Could not reschedule — slot may have been taken."},
    "panel.appointments.rescheduled":{"en": "Rescheduled to {doctor} on {date} at {time}.",
                             "si": "Rescheduled to {doctor} on {date} at {time}.",
                             "ta": "Rescheduled to {doctor} on {date} at {time}."},
    "panel.appointments.reschedule_cancel_ui":{"en": "Close reschedule", "si": "Close reschedule", "ta": "Close reschedule"},
